...
var (
	pkg       = flag.String("assert-path", "github.com/AndrewKlopper/go-jmespath/internal/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/AndrewKlopper/go-jmespath/internal/testify/_codegen
